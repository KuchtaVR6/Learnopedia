...
export const typeDefs = gql`
    ...
    type Mutation{
        ...
        modifyToParagraph(targetID : Int!, oldID : Int!, args : ParagraphInput!) : ContinueResponse
        
        insertPart(targetID : Int!, seqNumber : Int!, oldID : Int!) : ContinueResponse
        deletePart(targetID: Int!, oldID : Int!) : ContinueResponse 
